...
@section('content')
    <main id="main-content" class="body-container-wrapper">
        <div class="body-container body-container--contact">
                                ...
                                <div class="span12 widget-span widget-type-custom_widget dnd-module" style=""
                                    ...
                                    <div id="hs_cos_wrapper_dnd_area_101-dnd_partial-1-module-1"
                                        ...
                                        <div class="focus_module_fancy_header_container focus_centered">
                                            <h1 class="focus_module_fancy_header huge">Contact</h1>
                                        </div>
                                    </div>
                                </div>
                                <!--end widget-span -->
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="row justify-content-xl-center">
                                            <div class="col-12 col-xl-11">
                                                ...
                                                <p class="lead fs-4 text-secondary mb-5">We're always on the lookout to
                                                    work with new clients. If you're interested in working with us,
                                                    please get in touch in one of the following ways.</p>
                                                <div class="d-flex mb-5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <address class="mb-0 text-secondary">8014 Edith Blvd NE,
                                                    ...
                                                    <div class="col-12">
                                                        <div class="d-grid">
                                                            <button class="btn btn-primary btn-lg"
                                                                    style="box-shadow: none; background: #37517e;"
                                                                    type="submit">Send
                                                                Message
                                                            </button>
                                                        </div>
